...
/*
    ...
    void main()
    {
        gl_Position = ((mat4(vs_params[1], vs_params[2], vs_params[3], vs_params[4]) * mat4(vs_params[5], vs_params[6], vs_params[7], vs_params[8])) * mat4(vs_params[9], vs_params[10], vs_params[11], vs_params[12])) * position;
        vec3 _47 = normalize(normal);
        bvec3 _107 = bvec3(_47.x > 0.0);
        color = vec4(vec3(_107.x ? vec3(0.89999997615814208984375).x : vec3(0.20000000298023223876953125, 0.699999988079071044921875, 0.20000000298023223876953125).x, _107.y ? vec3(0.89999997615814208984375).y : vec3(0.20000000298023223876953125, 0.699999988079071044921875, 0.20000000298023223876953125).y, _107.z ? vec3(0.89999997615814208984375).z : vec3(0.20000000298023223876953125, 0.699999988079071044921875, 0.20000000298023223876953125).z) * ((vec3(0.0500000007450580596923828125) + (vec3(1.0) * max(0.0, dot(vec3(1.0), _47)))) + (vec3(1.0) * pow(max(0.0, dot(normalize(vec3(0.0, 0.0, 1.0)), normalize(reflect(vec3(-1.0), _47)))), 256.0))), 1.0);
    }

*/
@(private="file")
vs_source_glsl430 := [1197]u8 {
    ...
    0x6d,0x73,0x5b,0x34,0x5d,0x29,0x20,0x2a,0x20,0x6d,0x61,0x74,0x34,0x28,0x76,0x73,
    ...
    0x73,0x5b,0x38,0x5d,0x29,0x29,0x20,0x2a,0x20,0x6d,0x61,0x74,0x34,0x28,0x76,0x73,
    ...
    ,
    ...
    0x5f,0x31,0x30,0x37,0x2e,0x79,0x20,0x3f,0x20,0x76,0x65,0x63,0x33,0x28,0x30,0x2e,
    ...
    0x37,0x36,0x39,0x35,0x33,0x31,0x32,0x35,0x29,0x2e,0x79,0x2c,0x20,0x5f,0x31,0x30,
    0x37,0x2e,0x7a,0x20,0x3f,0x20,0x76,0x65,0x63,0x33,0x28,0x30,0x2e,0x38,0x39,0x39,
    ...
    0x2a,0x20,0x6d,0x61,0x78,0x28,0x30,0x2e,0x30,0x2c,0x20,0x64,0x6f,0x74,0x28,0x76,
    0x65,0x63,0x33,0x28,0x31,0x2e,0x30,0x29,0x2c,0x20,0x5f,0x34,0x37,0x29,0x29,0x29,
    ...
    0x74,0x28,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,0x28,0x76,0x65,0x63,0x33,
    ...
    0x65,0x63,0x74,0x28,0x76,0x65,0x63,0x33,0x28,0x2d,0x31,0x2e,0x30,0x29,0x2c,0x20,
    0x5f,0x34,0x37,0x29,0x29,0x29,0x29,0x2c,0x20,0x32,0x35,0x36,0x2e,0x30,0x29,0x29,
...
/*
    ...
    void main()
    {
        gl_Position = ((mat4(vs_params[1], vs_params[2], vs_params[3], vs_params[4]) * mat4(vs_params[5], vs_params[6], vs_params[7], vs_params[8])) * mat4(vs_params[9], vs_params[10], vs_params[11], vs_params[12])) * position;
        vec3 _47 = normalize(normal);
        vec3 _72 = normalize(vec3(0.0, 0.0, 1.0));
        bvec3 _107 = bvec3(_47.x > 0.0);
    ...
    0x34,0x39,0x32,0x31,0x38,0x37,0x35,0x2c,0x20,0x30,0x2e,0x32,0x30,0x30,0x30,0x30,
    0x30,0x30,0x30,0x32,0x39,0x38,0x30,0x32,0x33,0x32,0x32,0x33,0x38,0x37,0x36,0x39,
    0x35,0x33,0x31,0x32,0x35,0x29,0x2e,0x79,0x2c,0x20,0x5f,0x31,0x30,0x37,0x2e,0x7a,
    ...
    0x61,0x78,0x28,0x30,0x2e,0x30,0x2c,0x20,0x64,0x6f,0x74,0x28,0x76,0x65,0x63,0x33,
    0x28,0x31,0x2e,0x30,0x29,0x2c,0x20,0x5f,0x34,0x37,0x29,0x29,0x29,0x29,0x20,0x2b,
    ...
    0x37,0x32,0x2c,0x20,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,0x28,0x72,0x65,
    0x66,0x6c,0x65,0x63,0x74,0x28,0x76,0x65,0x63,0x33,0x28,0x2d,0x31,0x2e,0x30,0x29,
    0x2c,0x20,0x5f,0x34,0x37,0x29,0x29,0x29,0x29,0x2c,0x20,0x32,0x35,0x36,0x2e,0x30,
...
/*
    ...
    void vert_main()
    {
        gl_Position = mul(position, mul(_13_model, mul(_13_view, _13_proj)));
        float3 _47 = normalize(normal);
        bool3 _107 = (_47.x > 0.0f).xxx;
        color = float4(float3(_107.x ? 0.89999997615814208984375f.xxx.x : float3(0.20000000298023223876953125f, 0.699999988079071044921875f, 0.20000000298023223876953125f).x, _107.y ? 0.89999997615814208984375f.xxx.y : float3(0.20000000298023223876953125f, 0.699999988079071044921875f, 0.20000000298023223876953125f).y, _107.z ? 0.89999997615814208984375f.xxx.z : float3(0.20000000298023223876953125f, 0.699999988079071044921875f, 0.20000000298023223876953125f).z) * ((0.0500000007450580596923828125f.xxx + (1.0f.xxx * max(0.0f, dot(1.0f.xxx, _47)))) + (1.0f.xxx * pow(max(0.0f, dot(normalize(float3(0.0f, 0.0f, 1.0f)), normalize(reflect((-1.0f).xxx, _47)))), 256.0f))), 1.0f);
    }
...
vs_source_hlsl4 := [1831]u8 {
    ...
    ,
    ...
    0x74,0x28,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,0x28,0x66,0x6c,0x6f,0x61,
    0x74,0x33,0x28,0x30,0x2e,0x30,0x66,0x2c,0x20,0x30,0x2e,0x30,0x66,0x2c,0x20,0x31,
    0x2e,0x30,0x66,0x29,0x29,0x2c,0x20,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,
    0x28,0x72,0x65,0x66,0x6c,0x65,0x63,0x74,0x28,0x28,0x2d,0x31,0x2e,0x30,0x66,0x29,
    0x2e,0x78,0x78,0x78,0x2c,0x20,0x5f,0x34,0x37,0x29,0x29,0x29,0x29,0x2c,0x20,0x32,
    0x35,0x36,0x2e,0x30,0x66,0x29,0x29,0x29,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,
